                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                    {
                        skillsData.map((skill, i) => (
                            <div key={i} className="p-6 border border-teal-700 bg-teal-50/10 rounded-xl text-center cursor-pointer hover:border-b-4 hover:border-b-teal-800 hover:border-r-4 hover:border-r-teal-800 hover:-translate-y-1 transition-all duration-300">
